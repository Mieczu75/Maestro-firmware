...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, TFT_FRAMEWDT, 2, WA_LEFT }, 140, true, DSP_WIDTH/2+50, 5000, 2, 25 };//pasek z tytulem stacji
const ScrollConfig title1Conf     PROGMEM = {{ 1, 18, 1, WA_LEFT }, 140, true, DSP_WIDTH/2+50, 5000, 2, 25 };        //pierwszy pasek RDS
const ScrollConfig title2Conf     PROGMEM = {{ 1, 28, 1, WA_LEFT }, 140, true, DSP_WIDTH/2+50, 5000, 2, 25 };        //drugi pasek WYKONAWCA UTWORU
...
const ScrollConfig weatherConf    PROGMEM = {{ 20, 56, 1, WA_LEFT }, 140, true, DSP_WIDTH/2+40, 0, 2, 25 }; // scroling textu pogody
...
const BitrateConfig fullbitrateConf PROGMEM = {{234, 40, 1, WA_RIGHT}, 22 };

/* BANDS  */                             /* { onebandwidth, onebandheight, bandsHspace, bandsVspace, numofbands, fadespeed } */
//const VUBandsConfig bandsConf     PROGMEM = { 136, 3, 8, 1, 16, 5 };//{ 12, 48, 2, 1, 8, 3 };
const VUBandsConfig bandsConf     PROGMEM = { 210, 6, 7, 0, 1, 5 };//{ 12, 48, 2, 1, 8, 3 };
